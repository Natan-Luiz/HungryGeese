...
def agent(obs_dict, config_dict):    
    ...
    if direct == 0 and isEmpty(player_row+1,player_col,observation) and direction[player_index] != Action.NORTH.name:
        direction[player_index] = Action.SOUTH.name
    elif direct == 1 and isEmpty(player_row-1,player_col,observation) and direction[player_index] != Action.SOUTH.name:
        direction[player_index] = Action.NORTH.name 
    elif direct == 2 and isEmpty(player_row,player_col+1,observation) and direction[player_index] != Action.WEST.name:
